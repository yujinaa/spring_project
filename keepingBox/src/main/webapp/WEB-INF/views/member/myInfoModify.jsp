		...
		<div>
			<form action="${contextPath}/member/modifySave" method="post"
				...
				<input type="password" name="pwd" id="pwd" class="user-margin"
					placeholder="4~12자의 영문 대소문자와 숫자만 입력"> <input
					type="password" name="pwdchk" id="pwdchk" placeholder="비밀번호 재확인">
				<div id="pwdchk-info"></div>
				<label for="name">이름</label> <input type="text" name="name"
					id="name" value="${info.name }"> <label for="phone">휴대폰
					번호 (-없이)</label> <input type="tel" name="phone" id="phone"
					value="${info.phone }"> <label for="email">이메일</label> <input
					type="email" name="email" id="email" value="${info.email }">
