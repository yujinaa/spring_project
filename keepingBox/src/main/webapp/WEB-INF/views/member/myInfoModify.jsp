	...
	<div class="modify">
		...
		<div>
			<form action="${contextPath}/member/modifySave" method="post">
				...
				<input type="text" name="name" id="name" value="${info.name }"> <label for="phone">휴대폰
					번호 (-없이)</label> <input type="tel" name="phone" id="phone" value="${info.phone }"> <label
					for="email">이메일</label> <input type="email" name="email" id="email" value="${info.email }">
